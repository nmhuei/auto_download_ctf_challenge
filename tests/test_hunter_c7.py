...
Chạy: python3 -m pytest tests/test_hunter_c7.py -q
"""
...
def test_c5_2_platform_cung_marker_ctfd_thang_theo_priority():
    assert _MARKER_PRIORITY[:4] == ("rctf", "ctfd", "gzctf", "asisctf")   # chính sách core priority
    assert "tfcctf" in _MARKER_PRIORITY
    assert "noctf" in _MARKER_PRIORITY
